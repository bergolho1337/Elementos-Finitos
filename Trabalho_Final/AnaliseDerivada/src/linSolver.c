...
void solveLinearSystem (double *A, double *b, double *x, int N, int typeElem)
{
  // Para o elemento de Hermite o sistema linear eh (2N)x(2N)
  if (typeElem == 3)
    N *= 2;
  // Chama o resolvedor do LU
  solveLinearSystem_LU(A,b,x,N);

  printVector("Solution",x,N);
}
